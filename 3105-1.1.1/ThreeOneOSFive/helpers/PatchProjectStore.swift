...
final class PatchProjectStore: ObservableObject {
    ...
    init() {
        ...
        NotificationCenter.default.addObserver(
            self,
            selector: #selector(handlePatchLibraryDidChange(_:)),
            name: Notification.Name("PatchLibraryDidChange"),
            object: nil
        )
    }

    @objc
    private func handlePatchLibraryDidChange(_ note: Notification) {
        PatchProjectLibrary.ensurePreloadedPackagesInstalled()
        reload()
    }

    deinit {
        NotificationCenter.default.removeObserver(self, name: Notification.Name("PatchLibraryDidChange"), object: nil)
    }
